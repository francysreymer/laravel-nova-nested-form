...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@/components/Form/BelongsToField.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module '@/storage/BelongsToFieldStorage'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());


/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [!(function webpackMissingModule() { var e = new Error("Cannot find module '@/components/Form/BelongsToField.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())],
  methods: {
    /**
    ...
    getAvailableResources: function getAvailableResources() {
      ...
      return !(function webpackMissingModule() { var e = new Error("Cannot find module '@/storage/BelongsToFieldStorage'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).fetchAvailableResources(this.resourceName, this.field.originalAttribute, this.queryParams).then(function (_ref) {
...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@/components/Form/FileField.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [!(function webpackMissingModule() { var e = new Error("Cannot find module '@/components/Form/FileField.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())],
  methods: {
    /**
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this.uploadErrors = new laravel_nova__WEBPACK_IMPORTED_MODULE_2__["Errors"]();
                resourceName = _this.resourceName, resourceId = _this.resourceId, relatedResourceName = _this.relatedResourceName, relatedResourceId = _this.relatedResourceId, viaRelationship = _this.viaRelationship;
                attribute = _this.field.originalAttribute;
                uri = _this.viaRelationship ? "/nova-api/".concat(resourceName, "/").concat(resourceId, "/").concat(relatedResourceName, "/").concat(relatedResourceId, "/field/").concat(attribute, "?viaRelationship=").concat(viaRelationship) : "/nova-api/".concat(resourceName, "/").concat(resourceId, "/field/").concat(attribute);
                _context.prev = 4;
                _context.next = 7;
                return Nova.request()["delete"](uri);

              case 7:
                _this.closeRemoveModal();
              ...
              case 12:
                ...
                if (_context.t0.response.status == 422) {
                  _this.uploadErrors = new laravel_nova__WEBPACK_IMPORTED_MODULE_2__["Errors"](_context.t0.response.data.errors);
                }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
!(function webpackMissingModule() { var e = new Error("Cannot find module '@/components/Form/MorphToField.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module '@/storage/MorphToFieldStorage'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [!(function webpackMissingModule() { var e = new Error("Cannot find module '@/components/Form/MorphToField.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())],
  methods: {
    /**
     * Get the resources that may be related to this resource.
     */
    getAvailableResources: function getAvailableResources() {
      ...
      return !(function webpackMissingModule() { var e = new Error("Cannot find module '@/storage/MorphToFieldStorage'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).fetchAvailableResources(this.resourceName, this.field.originalAttribute, this.queryParams).then(function (_ref) {
        var _ref$data = _ref.data,
            resources = _ref$data.resources,
            softDeletes = _ref$data.softDeletes,
            withTrashed = _ref$data.withTrashed;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    addChild: function addChild() {
      ...
      if (this.field.children && this.field.children.length) {
        maxKey = this.field.children[this.field.children.length - 1].key || Math.max.apply(Math, this.field.children.map(function (_ref) {
          var id = _ref.id;
          return id;
        }));
      }
    ...
    replaceIndexesInSchema: function replaceIndexesInSchema(field) {
      ...
      schema.heading = schema.heading && schema.heading.replace(this.field.indexKey, this.field.children.length + 1) || "";
      return schema;
    }
  },
  ...
  created: function created() {
    for (var i = this.field.children && this.field.children.length || 0; i < this.field.min; i++) {
      this.addChild();
    }
  }
});
    ...
    shouldDisplay: function shouldDisplay() {
      ...
      var _loop = function _loop(i) {
        var _this2$field$displayI = _this2.field.displayIf[i],
            ...
            isNull = _this2$field$displayI.isNull,
            ...
            booleanGroup = _this2$field$displayI.booleanGroup;
        ...
        if (attribute) {
          ...
          if (typeof is !== "undefined") {
            ...
            shouldDisplay.push(values.every(function (o) {
              var oo = JSON.parse(JSON.stringify(o)).filter(function (x) {
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "bg-50 p-4 items-center text-90 flex justify-between nova-nested-form-header"
    },
    [
      _vm.heading
...
module.exports = __webpack_require__(/*! /Users/francysreymer/Documents/apps/laravel-nova-nested-form/resources/js/field.js */"./resources/js/field.js");
